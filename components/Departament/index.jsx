                ...
                >
                  <li className="nav-item">
                    ...
                    >
                      ...
                      <span className="first">Kardiologiya</span>
                  ...
                  <li className="nav-item">
                    ...
                    >
                      ...
                      <span className="first">Neurology</span>
                      <span className="second"></span>
                    </a>
                  </li>
                  <li className="nav-item">
                    ...
                    >
                      ...
                      <span className="first">Stomatologiya</span>
                      <span className="second"></span>
                    </a>
                  </li>
                  <li className="nav-item">
                    ...
                    >
                      <i className="icofont-heart-beat"></i>
                      <span className="first">Yurak Jarrohligi</span>
                      <span className="second"></span>
                    </a>
                  </li>
                  <li className="nav-item">
                    ...
                    >
                      ...
                      <span className="first">Ortopediya</span>
                      <span className="second"></span>
                    </a>
                  </li>
                </ul>
                    ...
                    <div className="row">
                      <div className="col-lg-6">
                        <div className="department-left">
                          ...
                          <p className="p1">
                            “Vivamus ut tellus sed tellus finibus egestas.
                          ...
                          <p>
                            ...
                            commodo magna rhoncus. In quis nisi non quam
                            pharetra commodo.{" "}
                          </p>
                          <ul className="list">
                            <li>
                              <i className="fa fa-check"></i>Maecenas vitae
                              luctus nibh. Curabitur pharetra luctus est, sit
                              amet aliquam ex posuere id.{" "}
                            </li>
                            <li>
                              <i className="fa fa-check"></i> Maecenas pharetra
                              ante vel est lobortis
                            </li>
                            <li>
